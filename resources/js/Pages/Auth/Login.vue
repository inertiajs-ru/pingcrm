    ...
    <div class="w-full max-w-md">
      ...
      <form class="mt-8 bg-white rounded-lg shadow-xl overflow-hidden" @submit.prevent="submit">
        <div class="px-10 py-12">
          <h1 class="text-center font-bold text-3xl">С возвращением!</h1>
          <div class="mx-auto mt-6 w-24 border-b-2" />
          <text-input v-model="form.email" :error="errors.email" class="mt-10" label="Эл. почта" type="email" autofocus autocapitalize="off" />
